...
export const Shop = () => {
  ...
  return (
    <section id="shop" ref={sectionRef} className="py-14 bg-gradient-to-br from-purple-50 via-pink-50 to-purple-50 relative overflow-hidden" aria-labelledby="shop-heading">
